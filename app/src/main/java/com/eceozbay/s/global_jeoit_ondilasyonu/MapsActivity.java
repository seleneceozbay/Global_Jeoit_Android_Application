...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener=new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                LatLng anlikkonum= new LatLng(location.getLatitude(),location.getLongitude());
                mMap.addMarker(new MarkerOptions().position(anlikkonum).title("Şu an buradasınız"));
    ...
    public void onMapLongClick(LatLng latLng) {
        mMap.clear();
        double fi=Math.toRadians(latLng.latitude);
        double lamda=Math.toRadians(latLng.longitude);
...
//zonal coefficients of the normal gravity C20, C40, C60 ... (GRS80)
      ...
      String aaa=sss.substring(1,8);
         ...
         mMap.addMarker(new MarkerOptions().position(latLng).title("N = "+aaa+" m"));
